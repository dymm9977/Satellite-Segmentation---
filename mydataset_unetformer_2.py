...
from geoseg.datasets.mydataset_dataset_2 import * #!
from geoseg.models.UNetFormer_2 import UNetFormer
...
train_dataset = UAVIDDataset(data_root='data/mydataset', img_dir='src', mask_dir='label',
                             mode='train', mosaic_ratio=0.25, transform=train_aug, img_size=(256, 256))

val_dataset = UAVIDDataset(data_root='data/mydataset', img_dir='src', mask_dir='label', mode='val',
